/* ===== rng.js — 可注入種子的亂數 =====
 * 賽道生成、道具抽取、AI 抖動一律走這裡。同一個 seed 一定得到同一個結果，
 * 才能讓重播、AI 驗證與線上同步完全重現。
 */
(function (root, factory) {
  ...
  /** 產一個新的隨機 seed（隨機賽道每局都要換） */
  function newSeed() {
    return 'cr-' + Date.now().toString(36) + '-' + Math.floor(Math.random() * 1e9).toString(36);
  }
